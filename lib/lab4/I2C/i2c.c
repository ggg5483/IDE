...
void I2C1_init(uint16_t targetAddress){
	...
	IOMUX->SECCFG.PINCM[IOMUX_PINCM16] = 		(IOMUX_PINCM_PC_CONNECTED  | IOMUX_PINCM16_PF_I2C1_SDA | IOMUX_PINCM_INENA_ENABLE);
	
	//config SCL
	//IOMUX->SECCFG.PINCM[IOMUX_PINCM15] &= ~IOMUX_PINCM_PF_MASK; //clear pf
	IOMUX->SECCFG.PINCM[IOMUX_PINCM15] = 		(IOMUX_PINCM_PC_CONNECTED | IOMUX_PINCM15_PF_I2C1_SCL | IOMUX_PINCM_INENA_ENABLE);
